define('rcinit',['we','ajax','dialog','cookie','select','placeholder','utils','rc/init/rc.ui','rc/init/rc.utils','rc/init/rc.fn.extend','theme'],function (require) {
    ...
    we.ui = require('rc/init/rc.ui');
    require('rc/init/rc.utils');
    require('rc/init/rc.fn.extend');
